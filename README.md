...
**Revisión de Directorio:** A través de Pytho se puede trabajar en conjunto los proyecto Git. 
...
Branch (rama): cada commit puede crear diferentes ramas, pero esta rama solamente conoce a su precedente. Las branch creadas por cada commit Git las llama Master. El programador puede trabajar en cada rama independiente de la versión. HEAD marca donde estamos trabajando.
